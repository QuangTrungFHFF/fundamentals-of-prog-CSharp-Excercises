...
namespace Exercise07
{
    internal class StudentTest
    {
        ...
        private static void Main(string[] args)
        {
            ...
            Console.WriteLine("Press any key to print student list!");
            Console.ReadKey();
            PrintStudentList();
        }
        ...
        /// <summary>
        /// Print result list to the screen
        /// </summary>
        public static void PrintStudentList()
        {
            Console.WriteLine("Number of students: {0}", Student.GetNumberOfStudents);
